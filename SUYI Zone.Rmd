...
df_long %>% 
  ggplot(aes(subject, rit_score, fill= suyi)) + scale_fill_manual(values=c("black","#AA0000")) + labs(title= "Average RIT Score by Semester" ,x = "Subject", y = "Average Score", fill= "Group") + geom_col(position = "dodge") + facet_wrap(~semester) + scale_y_continuous(breaks = c(0,50,100,150,200,250,300)) + coord_flip()
```
