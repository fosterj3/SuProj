...
kable(table, caption= "Total Number of Students in the Seattle University Youth Initiative Zone", col.names = c("School Name", "Percent (Total)")) %>% kable_styling(full_width = T, bootstrap_options = c("striped", "responsive"), position = "left", fixed_thead = T) %>% row_spec(c(17), bold = T)
...
kable(table, caption = "Student's Primary Language (Ten most spoken)", col.names = c("Primary Language", "Percent (Total)")) %>% kable_styling(full_width = T, bootstrap_options = c("striped", "responsive"), position = "left", fixed_thead = T)
