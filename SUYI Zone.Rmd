...
kable(table, caption= "Elementary Schools (K-5)", col.names = c("School Name", "Percent (Total)")) 
...
kable(table, caption= "Middle Schools (6-8)", col.names = c("School Name", "Percent (Total)")) 
...
kable(table, caption= "High Schools (9-12)", col.names = c("School Name", "Percent (Total)")) 
...
kable(table, caption = "Student's Racial Identity", col.names = c("Racial Identity", "Percent (Total)")) 
...
kable(table, caption = "Student's Primary Language", col.names = c("Primary Language", "Percent (Total)")) 
...
kable(table, caption = "Bilingual Students", col.names = c("Total", "Percent"))
...
kable(table, caption = "Students Experiencing Homelessness", col.names = c("Total", "Percent"))
...
df_long %>% 
  ggplot(aes(subject, rit_score, fill= semester)) + scale_fill_manual(values=c("black", "grey","#AA0000")) + labs(title= "Average RIT Score by Sex" ,x = "Subject", y = "Average Score", fill= "Group") + geom_col(position = "dodge")  + scale_y_continuous(breaks = c(0,50,100,150,200,250,300))  + facet_wrap(~sex + suyi)
```

```{r, warning=F, eval= FALSE}
#Average RIT Score by Grade Level
df_long %>% 
  ggplot(aes(subject, rit_score, fill= semester)) + scale_fill_manual(values=c("black", "grey","#AA0000")) + labs(title= "Average RIT Score by Grade Level" ,subtitle = "elementary is grades K-5, middle is 6-8, and high school is 9-12", x = "Subject", y = "Average Score", fill= "Group") + geom_col(position = "dodge") + facet_wrap(~grade_level, nrow = 3) + scale_y_continuous(breaks = c(150,200,250,300))
```
